...
class DummyModel(tf.keras.Model):
    def __init__(self, variable_names, variable_weights):
    ...
    # def get_config(self):
    #     return {"variable_names": self.variable_names, "variable_weights": self.variable_weights}
...
def ppo_run(params):
    ...
    for seed in params["SEEDS"]:
        ...
        test_layer = DummyLayer(variable_names[0], variables[0])
        ipdb.set_trace()
        model_keras = DummyModel(variable_names, weights)
        # model.save(curr_seed_dir + model.agent_name + "_full_model.h5", save_format='h5')
