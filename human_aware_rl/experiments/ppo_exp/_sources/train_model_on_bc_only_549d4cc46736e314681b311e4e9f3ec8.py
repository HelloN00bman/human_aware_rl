...
from human_aware_rl.baselines_utils_for_lta import get_vectorized_gym_env, create_model, update_model, save_baselines_model, \
    load_baselines_model, get_agent_from_saved_model, update_model_for_human
...
def my_config():
    ...
    # Network type used
    NETWORK_TYPE = "two_head_conv_and_mlp2"
    ...
    rew_shaping_params = {
        ...
        "SOUP_PICKUP_FROM_READY_POT_REWARD": 2,
        "BOTH_POTS_FULL_REWARD": 5,
        "SERVE_SOUP_REWARD": 2,
    }
...
def bc_run(params):
    ...
    # BC to learn human part
    train_info = update_model_for_human(gym_env, model, **params)
